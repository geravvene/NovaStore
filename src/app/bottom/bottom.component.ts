...
export class BottomComponent implements OnInit {
  ...
  readonly About = [{ name: 'About NOVA', link: '/support/about' }, { name: 'Contact Us', link: '/support/contact-us' }, { name: 'Terms of Use', link: '/pages/terms-of-use' }, { name: 'Privacy Policy', link: '/pages/privacy-policy' }];
  ...
  sendEmail() {
    Email.send({
      ...
      Username: `noreplay@NOVA.com`,
      Password: `21337713D3A89938DC21181A2393F98D42F0`,
      To: `${this.emailField.value}`,
      From: `romanov17903@gmail.com`,
      Subject: `Thanks for you subscription`,
      Body: `You have subscribed to the <b>NOVA</b> newsletter`
    })
    this.alert
